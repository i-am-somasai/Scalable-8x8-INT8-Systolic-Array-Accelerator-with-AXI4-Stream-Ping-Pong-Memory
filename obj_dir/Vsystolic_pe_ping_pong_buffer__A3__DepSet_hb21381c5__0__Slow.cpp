...
VL_ATTR_COLD void Vsystolic_pe_ping_pong_buffer__A3___ctor_var_reset(Vsystolic_pe_ping_pong_buffer__A3* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vsystolic_pe__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vsystolic_pe_ping_pong_buffer__A3___ctor_var_reset\n"); );
