...
#ifndef VERILATED_VSYSTOLIC_PE_SYSTOLIC_PE_H_
#define VERILATED_VSYSTOLIC_PE_SYSTOLIC_PE_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsystolic_pe_systolic_pe final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vsystolic_pe_systolic_pe(Vsystolic_pe__Syms* symsp, const char* v__name);
    ~Vsystolic_pe_systolic_pe();
    VL_UNCOPYABLE(Vsystolic_pe_systolic_pe);
